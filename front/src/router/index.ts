...
const SecurityPoliciesForm = () =>
  import("../views/security-policies/SecurityPoliciesForm.vue");
const AutoDeliveryForm = () =>
  import("../views/auto-delivery/AutoDeliveryForm.vue");
const Settlement = () => import("../views/Settlement.vue");
const NotificationPublish = () =>
  import("../views/notifications/NotificationPublish.vue");

const hasRoutePermission = (
  user: { username?: string; roles?: string[]; permissions?: string[] } | null,
...
const routes: RouteRecordRaw[] = [
  {
    ...
    name: "public-product",
    component: () =>
      import("../views/auto-delivery/publicBuy/PublicProduct.vue"),
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { path: "", redirect: "/codes/list" },
          {
            path: "list",
            name: "codes-list",
            component: () => import("../views/codes/CodesList.vue"),
            meta: { title: "注册码列表" },
          },
          {
            path: "generate",
            name: "codes-generate",
            component: () => import("../views/codes/CodesGenerate.vue"),
            meta: { title: "注册码生成" },
          },
        ],
      },
      {
        ...
        children: [
          ...
          {
            path: "list",
            name: "custom-data-list",
            component: () => import("../views/custom-data/CustomDataList.vue"),
            meta: { title: "自定义数据" },
          },
          {
            path: "create",
            name: "custom-data-create",
            component: CustomDataForm,
            meta: { title: "新增自定义数据" },
          },
          {
            path: "edit/:id",
            name: "custom-data-edit",
            component: CustomDataForm,
            meta: { title: "编辑自定义数据" },
          },
          {
            path: "help",
            name: "custom-data-help",
            component: () => import("../views/custom-data/CustomDataHelp.vue"),
            meta: { title: "使用说明" },
          },
        ],
      },
      {
        ...
        children: [
          { path: "", redirect: "/security-policies/list" },
          {
            ...
            component: () =>
              import("../views/security-policies/SecurityPoliciesList.vue"),
            meta: { title: "安全策略管理" },
          },
          {
            path: "create",
            name: "security-policies-create",
            component: SecurityPoliciesForm,
            meta: { title: "新增安全策略" },
          },
          {
            path: "edit/:id",
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "list",
            name: "auto-delivery-list",
            component: () =>
              import("../views/auto-delivery/AutoDeliveryList.vue"),
            meta: { title: "商品管理" },
          },
          {
            path: "orders",
            name: "auto-delivery-orders",
            component: () =>
              import("../views/auto-delivery/AutoDeliveryOrders.vue"),
            meta: { title: "已卖出的商品" },
          },
          {
            path: "create",
            name: "auto-delivery-create",
            component: AutoDeliveryForm,
            meta: { title: "商品添加" },
          },
          {
            path: "edit/:id",
            name: "auto-delivery-edit",
            component: AutoDeliveryForm,
            meta: { title: "编辑商品" },
          },
        ],
      },
      {
        ...
        children: [
          { path: "", redirect: "/users/settlements" },
          {
            path: "operation",
            name: "logs-operation",
            component: () => import("../views/logs/LogsOperation.vue"),
            meta: { title: "操作日志" },
          },
          {
            path: "login",
            name: "logs-login",
            component: () => import("../views/logs/LogsLogin.vue"),
            meta: { title: "登录日志" },
          },
          {
            path: "error",
            name: "logs-error",
            component: () => import("../views/logs/LogsError.vue"),
            meta: { title: "错误日志" },
          },
          {
            path: "/users/settlements",
            name: "system-settlements",
      ...
      { path: "settlements", redirect: "/users/settlements" },
      {
        ...
        meta: { title: "通知中心", requiresAdmin: true },
      },
      {
        path: "profile",
...
router.beforeEach((to, _from, next) => {
  ...
  const requiredPermissions = to.matched.flatMap(
    (record) => (record.meta?.permissions as string[] | undefined) || [],
  );
