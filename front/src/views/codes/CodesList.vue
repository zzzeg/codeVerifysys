...
<template>
  <div class="codes-list-page">
    ...
    <div class="tableColums">
      ...
      <!-- 表格 -->
      <el-table ref="tableRef" :data="list" stripe v-loading="loading"
        ...
        <el-table-column label="激活时间/到期时间/最后访问时间">
          <template #default="{ row }">
            <div class="time-info">
        ...
        <el-table-column label="解绑密码" width="100">
          <template #default="{ row }">
...
.codes-list-page {
  ...
  .tableColums {
    // Assuming tableColums contains toolbar, table, and pagination
    flex: 1;
    display: flex;
    flex-direction: column;
