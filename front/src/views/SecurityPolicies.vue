...
const currentTitle = computed(() => {
  if (route.name === 'security-policies-create') return '新增安全策略'
  if (route.name === 'security-policies-edit') return '编辑安全策略'
  return '安全策略管理'
})

const sideItems = [
  { label: '策略列表', path: '/security-policies/list', names: ['security-policies-list'] },
  { label: '新增策略', path: '/security-policies/create', names: ['security-policies-create'] },
]
  ...
  <div class="vs-ref-shell">
    <div class="vs-ref-frame auto-frame">
      <aside class="auto-side">
        <div class="auto-side-head">安全策略</div>
