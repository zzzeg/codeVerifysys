...
const currentTitle = computed(() => {
  if (route.name === 'products-create') return '新增商品'
  if (route.name === 'products-edit') return '编辑商品'
  return '商品管理'
})

const sideItems = [
  { label: '商品管理', path: '/products/list', names: ['products-list'] },
  { label: '添加商品', path: '/products/create', names: ['products-create'] },
]
  ...
  <div class="vs-ref-shell">
    <div class="vs-ref-frame auto-frame">
      <aside class="auto-side">
        <div class="auto-side-head">商品管理</div>
