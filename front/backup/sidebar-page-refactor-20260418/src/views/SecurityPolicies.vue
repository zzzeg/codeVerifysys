    ...
    <div class="vs-ref-frame">
      <section class="vs-ref-main">
        <div class="vs-ref-main-head">
          <div class="head-row">
            <h2 class="vs-ref-main-title">安全策略管理</h2>
      ...
      <div class="policy-form">
        ...
        <template v-if="form.status === 'enabled'">
          ...
          <template v-if="form.mode === 'basic'">
            <div class="section">
              <div class="section-title">验证接口安全策略 <span class="warn">影响注册码详情信息</span></div>
              <div class="section-body">
                <el-form label-width="120px">
            ...
            <div class="section">
              <div class="section-title">辅助接口安全策略 <span class="warn">影响自定义数据、获取注册码备注信息</span></div>
              <div class="section-body">
                <el-form label-width="120px">
                  <el-form-item label="通讯加密：">
                ...
                <el-form label-width="auto">
                  <el-form-item label="通讯加密：">
                    <div class="algo-grid">
                      <div v-for="a in algoTags" :key="a" class="algo-row">
                        ...
                        <span class="help">只能是数字与字母，最长为16个字符</span>
                      </div>
                    </div>
                  </el-form-item>
                  ...
                  <el-form-item label="加密后数据前缀：">
                    <el-radio-group v-model="form.advanced.verifyApi.prefixMode">
                      <el-radio value="fixed">固定字符</el-radio>
                      <el-radio value="random">随机字符</el-radio>
                    </el-radio-group>
