...
<template>
  <div class="codes-list-page vs-page-shell" :class="{ 'detail-open': showDetail }">
    ...
    <div class="filter-section">
      ...
      <div class="filter-row tableuse">
        ...
        <el-checkbox-group v-model="filters.cardTypes">
          <el-checkbox label="trial">试用卡</el-checkbox>
    ...
    <div class="tableColums">
      ...
      <!-- 表格 -->
      <el-table ref="tableRef" :data="list" stripe v-loading="loading" :cell-style="{ textAlign: 'center' }" :header-cell-style="{ 'text-align': 'center' }"
        @row-click="handleRowClick" @selection-change="handleSelectionChange" style="width: 100%;height:calc(100vh - 630px)" size="small">
        <el-table-column type="selection" width="40" />
        <!-- <el-table-column type="index" width="40" /> -->
        <el-table-column prop="code" label="注册码" width="240" />
...
.filter-row {
  ...
  &.table_flexrow {
    ...
    padding: 14px 16px;
    border-radius: 18px;
    background: linear-gradient(135deg, rgba(246, 250, 255, 0.96), rgba(240, 245, 252, 0.92));
    border: 1px solid rgba(148, 163, 184, 0.16);
  }
