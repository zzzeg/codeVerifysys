        ...
        <div class="vs-ref-main-body">
          <div class="vs-page-toolbar page-actions">
            <div class="vs-toolbar-group">
              <button
                type="button"
                class="vs-ref-side-link tab-btn"
            ...
            <div class="vs-toolbar-group vs-toolbar-group--end">
              <el-button type="primary" @click="openDialog()">添加自定义数据</el-button>
            </div>
          </div>

          <div v-if="activeTab === 'list'">
            <h3 class="vs-ref-section-title">自定义数据管理</h3>
            ...
            <el-table :data="list" v-loading="loading" style="width: 100%" border>
              ...
              <el-table-column label="操作" width="180">
                <template #default="{ row }">
                  ...
                  <el-link type="danger" style="margin-left: 8px" @click="removeData(row)">删除</el-link>
                </template>
              </el-table-column>
            </el-table>
            <div class="pager">
